...
▌範本 4:議價型客戶 → 不降價,給替代
客戶:太貴了 有沒有便宜一點的?
你:理解您的考量 🙏 老師有準備不同層級的服務:
如果您現在只是想針對「一個明確的問題」找答案,
可以選「易經占卜」NT$ 1,000,大約 10-15 分鐘就能拿到方向;
但如果您是想要「整體看自己」、之後一整年都能持續問,
那紫微 NT$ 4,000 平均下來一天才 11 塊,反而最划算。
您比較想先解決哪個層次的問題呢?

▌範本 5:猶豫型客戶 → 軟收單 + 製造輕微急迫
客戶:我再考慮看看
你:當然沒問題,這種事本來就要慎重 🙏
只是想跟您說,老師最近檔期比較滿,
這個月還剩 3 個諮詢名額。
